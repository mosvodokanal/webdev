...
$docker-machine ssh webdev-node2
[root@webdev-node2 ~]# docker swarm join --token SWMTKN-1-1dxvinedorsqgxc0nb7rg3vpgsmmcs7mwn2onebnccev05ca7l-8vdamkos52tcxo0qzhhis0aoe 172.16.3.16:2377
